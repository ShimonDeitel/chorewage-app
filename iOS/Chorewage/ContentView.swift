...
struct ContentView: View {
    ...
    @State private var editingItem: Payout?
    ...
    private func amountText(_ item: Payout) -> String? {
...
struct EntryFormView: View {
    ...
    let mode: FormMode
    @State private var draft: Payout

    init(mode: FormMode) {
        self.mode = mode
        switch mode {
        case .add:
            _draft = State(initialValue: Payout())
        case .edit(let item):
    ...
    var body: some View {
        NavigationStack {
            Form {
                Section {
                    TextField("Person", text: $draft.person)
                        .accessibilityIdentifier("field_person")
                    TextField("Chore", text: $draft.chore)
                        .accessibilityIdentifier("field_chore")
